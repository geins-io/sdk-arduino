...
/*
 * ProductParameter.Models.Write.ProductParameterPredefinedValue.h
 *
 * A predefined value for a product parameter.
 */

#ifndef TINY_CPP_CLIENT_ProductParameter.Models.Write.ProductParameterPredefinedValue_H_
#define TINY_CPP_CLIENT_ProductParameter.Models.Write.ProductParameterPredefinedValue_H_
...
class ProductParameter.Models.Write.ProductParameterPredefinedValue{
public:

    /*! \brief Constructor.
	 */
    ProductParameter.Models.Write.ProductParameterPredefinedValue();
    ProductParameter.Models.Write.ProductParameterPredefinedValue(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~ProductParameter.Models.Write.ProductParameterPredefinedValue();
...
#endif /* TINY_CPP_CLIENT_ProductParameter.Models.Write.ProductParameterPredefinedValue_H_ */
