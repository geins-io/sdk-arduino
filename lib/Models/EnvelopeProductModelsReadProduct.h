...
/*
 * Envelope-Product.Models.Read.Product.h
 *
 * An envelope for the result of and action taken on a resource.
 */

#ifndef TINY_CPP_CLIENT_Envelope-Product.Models.Read.Product_H_
#define TINY_CPP_CLIENT_Envelope-Product.Models.Read.Product_H_
...
class Envelope-Product.Models.Read.Product{
public:

    /*! \brief Constructor.
	 */
    Envelope-Product.Models.Read.Product();
    Envelope-Product.Models.Read.Product(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~Envelope-Product.Models.Read.Product();
	...
	/*! \brief Get 
	 */
	Product.Models.Read.Product getResource();

	/*! \brief Set 
	 */
	void setResource(Product.Models.Read.Product  resource);
	/*! \brief Get 
	 */
    ...
    Product.Models.Read.Product resource;
    PageResult pageResult;
};
}

#endif /* TINY_CPP_CLIENT_Envelope-Product.Models.Read.Product_H_ */
