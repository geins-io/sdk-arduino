...
/*
 * Supplier.Models.Read.Supplier.h
 *
 * A product supplier.
 */

#ifndef TINY_CPP_CLIENT_Supplier.Models.Read.Supplier_H_
#define TINY_CPP_CLIENT_Supplier.Models.Read.Supplier_H_
...
class Supplier.Models.Read.Supplier{
public:

    /*! \brief Constructor.
	 */
    Supplier.Models.Read.Supplier();
    Supplier.Models.Read.Supplier(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~Supplier.Models.Read.Supplier();
	...
	/*! \brief Get The unique identifier for the supplier.
	 */
	int getSupplierId();

	/*! \brief Set The unique identifier for the supplier.
	 */
...
#endif /* TINY_CPP_CLIENT_Supplier.Models.Read.Supplier_H_ */
